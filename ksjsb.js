...
class _0x9d8dda {
    ...
    async [IM(0x441)](T) {
        ...
        if (!a) return;
        try {
            a['result'] == 0x1 ? console[c[Vp(0x99a)]](c[Vp(0x56d)](c['gUYzE'](c['lDdxm'](c[Vp(0x56d)](c[Vp(0x431)] + this[c[Vp(0x635)]], Vp(0xc05)), T[c[Vp(0xc40)]]), c['ppPFQ']), 
            a[c[Vp(0x78b)]][c[Vp(0x268)]]?a[c[Vp(0x78b)]][c[Vp(0x268)]]['taskRewardName']:" taskRewardName Null"
