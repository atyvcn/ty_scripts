...
class _0x9d8dda {
    ...
    async [IM(0x441)](T) {
        ...
        if (!a) return;
        try {
           if(a['result'] == 0x1){//获得奖励
            //console[c[Vp(0x99a)]](c[Vp(0x56d)](c['gUYzE'](c['lDdxm'](c[Vp(0x56d)](c[Vp(0x431)] + this[c[Vp(0x635)]], Vp(0xc05)), T[c[Vp(0xc40)]]), c['ppPFQ']),a[c[Vp(0x78b)]][c[Vp(0x268)]]['taskRewardName']))
            let aaa=a[c[Vp(0x78b)]][c[Vp(0x268)]];
            console.log(
                c[Vp(0x56d)](
                    c['gUYzE'](
                        c['lDdxm'](c[Vp(0x56d)](c[Vp(0x431)] + this[c[Vp(0x635)]], Vp(0xc05)), T[c[Vp(0xc40)]]), c['ppPFQ']
                    ),
                    aaa?aaa['taskRewardName']:" taskRewardName Null"
                )
            );
           }else{
            //console[Vp(0x75b)](c[Vp(0x70d)](c['lDdxm'](c['WAZTE'] + this[c[Vp(0x635)]] + c[Vp(0x741)], T[c[Vp(0xc40)]]), c[Vp(0x3f8)]) + a[c[Vp(0x786)]]);
            console.log(c[Vp(0x70d)](c['lDdxm'](c['WAZTE'] + this[c[Vp(0x635)]] + c[Vp(0x741)], T[c[Vp(0xc40)]]), c[Vp(0x3f8)]) + a[c[Vp(0x786)]]);
           }
        } catch (C) {
            console.log(C);
       }
